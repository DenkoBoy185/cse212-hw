...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue was implementing a LIFO stack instead of a FIFO queue. AddPerson was adding to the front instead of the back.
    ...
    // Defect(s) Found: PersonQueue implemented LIFO (stack) instead of FIFO (queue).
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: TakingTurnsQueue did not re-enqueue people when their turns were 0 or less (infinite). PersonQueue was LIFO instead of FIFO.
    ...
    // Defect(s) Found: None found in this specific test. Exception handling was correct.
